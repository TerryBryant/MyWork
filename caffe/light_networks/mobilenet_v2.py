...
def MobilenetV2Body(net, from_layer, use_pool6=True, use_dilation_conv5=False, **bn_param):
    ...
    invert_residual_block(net, net.keys()[-1], 'conv5_3', 576, 576, 160, 2, False, **bn_param)
...
MobilenetV2Body(net, from_layer='data', use_pool6=True, use_dilation_conv5=True)
...
with open('train_mobilenetv2.prototxt', 'w') as f:
    print('name: "{}_train"'.format('mobilenetv2'), file=f)
